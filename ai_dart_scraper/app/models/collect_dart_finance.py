...
class CollectDartFinance(BaseCollections):
    ...
    thstrm_amount = Column(String(1000), nullable=True, comment='당기금액')
    thstrm_add_amount = Column(String(1000), nullable=True, comment='당기누적금액')
    frmtrm_nm = Column(String(45), nullable=True, comment='전기명')
    frmtrm_amount = Column(String(1000), nullable=True, comment='전기금액')
    frmtrm_q_nm = Column(String(45), nullable=True, comment='전기분기명')
    frmtrm_q_amount = Column(String(1000), nullable=True, comment='전기분기금액')
    frmtrm_add_amount = Column(String(1000), nullable=True, comment='전기누적금액')
    bfefrmtrm_nm = Column(String(45), nullable=True, comment='전전기명')
    bfefrmtrm_amount = Column(String(1000), nullable=True, comment='전전기금액')
    ord = Column(String(45), comment='계정정렬순서')
